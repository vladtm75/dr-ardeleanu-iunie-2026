...
const DATA = [
  ...
  { m: "Jan 26", cashOpen: 321905, ebitda: 950058, opCF: 873786, invCF: -350217, finCF: -682887, wcCF: 530953, totalGen: 371635, cashEnd: 693540, capexRE: 0, capexFitout: -50614, capexEQ: -299603, payTotal: 2979101, payCurrent: 2852740, payEuroFunds: 0, payPropco: 126361, daysTotal: 27, daysCurrent: 26, daysEuroFunds: 0, daysPropco: 0, netBankDebt: 6988705, fiscalDebt: 188352, totalDebt: 7177057, totalDebtEUR: 1435411, odMov: 37081, odBal: 689220, ilBal: 4219841, ilBalEUR: 843968, shSpend: 68651, shSpendEUR: 13730 },
  { m: "Feb 26", cashOpen: 693540, ebitda: 834657, opCF: 777382, invCF: -973836, finCF: -162124, wcCF: 683460, totalGen: 324882, cashEnd: 1018422, capexRE: 0, capexFitout: -717020, capexEQ: -256816, payTotal: 3856445, payCurrent: 2530309, payEuroFunds: 783833, payPropco: 542303, daysTotal: 34, daysCurrent: 23, daysEuroFunds: 7, daysPropco: 0, netBankDebt: 8507552, fiscalDebt: 162187, totalDebt: 8669739, totalDebtEUR: 1733948, odMov: 93171, odBal: 782391, ilBal: 4503841, ilBalEUR: 900768, shSpend: 216405, shSpendEUR: 43281 },
  { m: "Mar 26", cashOpen: 1018422, ebitda: 1128656, opCF: 1061059, invCF: -546616, finCF: -551398, wcCF: 155799, totalGen: 118844, cashEnd: 1137266, capexRE: 0, capexFitout: -463586, capexEQ: -83030, payTotal: 3563375, payCurrent: 2329597, payEuroFunds: 783833, payPropco: 449945, daysTotal: 26, daysCurrent: 17, daysEuroFunds: 6, daysPropco: 0, netBankDebt: 8475692, fiscalDebt: 136022, totalDebt: 8611714, totalDebtEUR: 1722343, odMov: -331472, odBal: 450919, ilBal: 4683841, ilBalEUR: 936768, shSpend: 10647, shSpendEUR: 2129 },
  { m: "Apr 26", cashOpen: 1137266, ebitda: 771543, opCF: 644418, invCF: -1185329, finCF: 725912, wcCF: -133419, totalGen: 51582, cashEnd: 1188848, capexRE: -25464, capexFitout: -88124, capexEQ: -1071741, payTotal: 3470222, payCurrent: 2341991, payEuroFunds: 783833, payPropco: 344398, daysTotal: 29, daysCurrent: 20, daysEuroFunds: 7, daysPropco: 1, netBankDebt: 8398663, fiscalDebt: 360279, totalDebt: 8758942, totalDebtEUR: 1751788, odMov: 201317, odBal: 652236, ilBal: 4758841, ilBalEUR: 951768, shSpend: 245505, shSpendEUR: 49101 }
];
const fmtRON = (v, opts = {}) => {
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("header", { style: {
      ...
      /* @__PURE__ */ jsx("h1", { style: {
        ...
        lineHeight: 1.2,
        letterSpacing: -0.2
      }, children: "April 2026 Cashflow Position \u2013 Dr. Ardeleanu" }),
      /* @__PURE__ */ jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { maxWidth: 1280, margin: "0 auto", padding: "0 28px" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 14, marginBottom: 18, flexWrap: "wrap" }, children: [
        ...
        /* @__PURE__ */ jsx(
          KPI,
          {
            ...
            sub: `Normalises off March record \xB7 vs avg ${fmtRON(totals.ebitda / DATA.length)}`,
            accent: C.amberGold,
            trend: ebitdaMoM
          }
        ),
        /* @__PURE__ */ jsx(
          KPI,
          {
            ...
            sub: `vs 15-mo avg ${avgDaysTotal.toFixed(0)}d \xB7 above average on payables build`,
            accent: C.terracotta,
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, lineHeight: 1.55, color: C.text }, children: [
          /* @__PURE__ */ jsx("strong", { children: "April is a heavy investment month, largely grant-funded" }),
          " \u2014 a major equipment purchase lifts investing outflows to ",
          fmtRONfull(latest.invCF),
          " RON, while a 935k RON EU grant inflow turns financing net positive at +",
          fmtRONfull(latest.finCF),
          " RON, so cash on hand still edges up to ",
          ...
          " (",
          fmtPct(cashMoM),
          " MoM). Operating cash normalises off March's record to ",
          ...
          ". A working-capital build pushes days of payables to ",
          /* @__PURE__ */ jsxs("strong", { children: [
            latest.daysTotal,
            " days"
          ] }),
          ...
          prev.daysTotal,
          ", vs a ",
          avgDaysTotal.toFixed(0),
          "-day average), lifting total payables ",
          fmtPct((latest.payTotal - prev.payTotal) / prev.payTotal * 100),
          " to ",
          fmtRON(latest.payTotal),
          " RON; the overdraft is drawn a further +",
          fmtRON(latest.odMov),
          " RON to ",
          fmtRONfull(latest.odBal),
          " RON (",
          (latest.odBal / OVERDRAFT_LIMIT * 100).toFixed(0),
          "% of facility). Total debt holds at ",
          /* @__PURE__ */ jsxs("strong", { children: [
            "\u20AC",
          ...
          "x Net Debt/TTM EBITDA); fiscal debt ticked up to ",
          fmtRON(latest.fiscalDebt),
          " RON on the month but stays ",
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          title: "April 2026 \u2014 Cash Bridge",
          subtitle: "From opening cash on 1 April to closing cash on 30 April. The operating engine generates 0.64M RON; investing absorbs a heavy 1.19M, driven by a major equipment purchase; financing turns net positive at +0.73M as a 0.94M EU grant inflow more than covers debt service, dividends and related-entity loans; working capital draws down a further 0.13M. Net result is a marginal +0.05M for the month.",
          children: [
        ...
        Section,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 320, children: /* @__PURE__ */ jsxs(ComposedChart, { data: DATA, margin: { top: 10, right: 20, left: 0, bottom: 5 }, children: [
              ...
              /* @__PURE__ */ jsx(Bar, { yAxisId: "left", dataKey: "payEuroFunds", stackId: "p", name: "European Funds payables", fill: C.olive, radius: [0, 0, 0, 0] }),
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              /* @__PURE__ */ jsx(AggregateBox, { color: C.primary, label: "Total Payables Apr 26", value: fmtRONfull(latest.payTotal), sub: "OPCO + PROPCO" }),
              /* @__PURE__ */ jsx(AggregateBox, { color: C.text, label: "vs Mar 26", value: fmtPct((latest.payTotal - prev.payTotal) / prev.payTotal * 100), sub: `\u0394 ${fmtRON(latest.payTotal - prev.payTotal)} RON` }),
              /* @__PURE__ */ jsx(AggregateBox, { color: C.amberGold, label: "Days of Payables", value: latest.daysTotal + " days", sub: `+${latest.daysTotal - prev.daysTotal}d MoM \xB7 payables build` }),
              ...
              /* @__PURE__ */ jsx(AggregateBox, { color: C.olive, label: "European Funds", value: fmtRONfull(latest.payEuroFunds), sub: `${latest.daysEuroFunds} days \xB7 new since Jan 26` })
            ] })
          ]
        }
      ),
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `${fmtPct(fiscalDebtMoM, 0)} MoM \xB7 ${fmtPct(fiscalDebtChange, 0)} vs Feb 25`
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `Apr 25: ${fmtRON(yearAgo.totalDebt)} \u2192 Apr 26: ${fmtRON(latest.totalDebt)}`
                }
              )
            ] })
          ]
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  color: C.terracotta,
                  label: "Apr 26 drawdown",
                  value: "+" + fmtRONfull(Math.abs(latest.odMov)) + " RON",
                  sub: "Drawn to fund working capital"
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          subtitle: "Cumulative cash deployed from Dr. Ardeleanu OPCO into related/holding entities. Steady accumulation through Q1\u2013Q3 2025, then a sharp Q4 2025 deployment phase. April 2026 adds a modest 75,000 RON, keeping the cumulative balance broadly flat.",
          children: [
            /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(
              ComposedChart,
              {
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `From \u20AC${fmtRONfull(DATA[0].ilBalEUR)} (Feb 25) to \u20AC${fmtRONfull(latest.ilBalEUR)} (Apr 26)`
                }
              )
            ] })
          ]
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          subtitle: /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            " cash distributions to shareholders \u2014 figures already exclude any amounts reinvested back into the company via DP. Only money that effectively left the business is shown. Aug 2025 marks the peak (\u20AC136,572) reflecting an extraordinary distribution. After a near-zero March (\u20AC2,129), April returns to a normal cadence at ",
            /* @__PURE__ */ jsxs("strong", { children: [
              "\u20AC",
              fmtRONfull(latest.shSpendEUR)
            ] }),
            ", still comfortably below the series average."
          ] }),
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `\u20AC${fmtRONfull(latest.shSpendEUR)} \xB7 normal cadence`
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `\u20AC${fmtRONfull(DATA.slice(-12).reduce((a, r) => a + r.shSpendEUR, 0))} \xB7 May 25 \u2013 Apr 26`
                }
              )
            ] })
          ]
      ...
      /* @__PURE__ */ jsxs("footer", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: C.muted }, children: [
          ...
          " \xB7 CFO Reporting \xB7 Treasury & Cashflow \xB7 Period: Feb 2025 \u2013 Apr 2026 \xB7 All figures in RON \xB7 OPCO + PROPCO consolidated"
        ] }),
