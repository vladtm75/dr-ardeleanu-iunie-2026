  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxs("header", { style: {
      ...
      /* @__PURE__ */ jsx("h1", { style: {
        ...
        lineHeight: 1.2,
        letterSpacing: -0.2
      }, children: "May 2026 CASHFLOW Analysis \u2013 Dr. Ardeleanu" }),
      /* @__PURE__ */ jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxs("div", { style: { maxWidth: 1280, margin: "0 auto", padding: "0 28px" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 14, marginBottom: 18, flexWrap: "wrap" }, children: [
        ...
        /* @__PURE__ */ jsx(
          KPI,
          {
            ...
            sub: `vs 15-mo avg ${avgDaysTotal.toFixed(0)}d \xB7 second-fastest pace in window (behind Mar 26)`,
            accent: C.terracotta,
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, lineHeight: 1.55, color: C.text }, children: [
          /* @__PURE__ */ jsx("strong", { children: "May is a heavy deleveraging and investment month, with no grant to offset it" }),
          " \u2014 a ",
          fmtRON(Math.abs(latest.capexRE)),
          " RON real-estate purchase plus ",
          fmtRON(Math.abs(latest.capexFitout)),
          " RON of fitout spend push investing outflows to ",
          fmtRONfull(Math.abs(latest.invCF)),
          " RON, while financing swings to ",
          /* @__PURE__ */ jsxs("strong", { children: [
            fmtRONfull(latest.finCF),
            " RON"
          ] }),
          " as the overdraft is repaid by ",
          fmtRONfull(Math.abs(latest.odMov)),
          " RON and dividends plus a further related-entity loan go out the door, so cash on hand falls to ",
          /* @__PURE__ */ jsxs("strong", { children: [
          ...
          " (",
          fmtPct(cashMoM),
          " MoM) \u2014 the sharpest single-month drawdown since December 2025. The operating engine is the bright spot: EBITDA rebounds to ",
          fmtRONfull(latest.ebitda),
          " RON (",
          fmtPct(ebitdaMoM),
          " MoM), delivering ",
          fmtRONfull(latest.opCF),
          " RON of operating cash flow (",
          fmtPct(opCFMoM),
          " MoM, ",
          /* @__PURE__ */ jsxs("strong", { children: [
            fmtPct(opCFYoY),
          ...
          "% conversion rate. Working-capital discipline sharpens further \u2014 days of payables fall to ",
          /* @__PURE__ */ jsxs("strong", { children: [
            latest.daysTotal,
            " days"
          ] }),
          ...
          "-day average), cutting total payables ",
          fmtPct((latest.payTotal - prev.payTotal) / prev.payTotal * 100),
          " to ",
          fmtRON(latest.payTotal),
          " RON. The overdraft is more than halved to ",
          fmtRONfull(latest.odBal),
          " RON (",
          (latest.odBal / OVERDRAFT_LIMIT * 100).toFixed(0),
          "% of facility, from ",
          (prev.odBal / OVERDRAFT_LIMIT * 100).toFixed(0),
          "% in April) \u2014 the lowest utilisation since the facility was first drawn; fiscal debt continues its paydown to ",
          fmtRON(latest.fiscalDebt),
          " RON (",
          fmtPct(fiscalDebtChange),
          " below the start of the window), while total debt eases to ",
          /* @__PURE__ */ jsxs("strong", { children: [
            "\u20AC",
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          title: "May 2026 \u2014 Cash Bridge",
          subtitle: "From opening cash on 1 May to closing cash on 31 May. The operating engine generates a strong 1.00M RON; investing absorbs 0.88M, split between a 0.49M real-estate purchase and 0.39M of fitout spend; financing turns sharply negative at -1.00M as the overdraft is repaid by 0.34M, dividends of 0.25M go out and a further 0.23M is loaned to related entities, with no EU grant landing this month; working capital releases a further 0.19M as payables are paid down faster. Net result is a -0.69M contraction for the month, the sharpest since December 2025.",
          children: [
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          subtitle: "Closing cash balance by month with monthly net cash generation. The December 2025 trough reflects a one-off EBITDA dip combined with heavy working-capital absorption. May 2026 posts the second-largest monthly drawdown in the window as a real-estate purchase and overdraft paydown outpace an otherwise strong operating quarter.",
          children: [
        ...
        Section,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              /* @__PURE__ */ jsx(AggregateBox, { color: C.primary, label: "Total Payables May 26", value: fmtRONfull(latest.payTotal), sub: "OPCO + PROPCO" }),
              /* @__PURE__ */ jsx(AggregateBox, { color: C.text, label: "vs Apr 26", value: fmtPct((latest.payTotal - prev.payTotal) / prev.payTotal * 100), sub: `\u0394 ${fmtRON(latest.payTotal - prev.payTotal)} RON` }),
              /* @__PURE__ */ jsx(AggregateBox, { color: C.amberGold, label: "Days of Payables", value: latest.daysTotal + " days", sub: `${latest.daysTotal - prev.daysTotal >= 0 ? "+" : ""}${latest.daysTotal - prev.daysTotal}d MoM \xB7 paid down faster` }),
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `${fmtPct(fiscalDebtMoM, 0)} MoM \xB7 ${fmtPct(fiscalDebtChange, 0)} vs Mar 25`
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `May 25: ${fmtRON(yearAgo.totalDebt)} \u2192 May 26: ${fmtRON(latest.totalDebt)}`
                }
              )
            ] })
          ]
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  color: C.olive,
                  label: "May 26 repayment",
                  value: "-" + fmtRONfull(Math.abs(latest.odMov)) + " RON",
                  sub: "Repaid from operating cash"
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          subtitle: "Cumulative cash deployed from Dr. Ardeleanu OPCO into related/holding entities. Steady accumulation through Q1\u2013Q3 2025, then a sharp Q4 2025 deployment phase. May 2026 adds 229,000 RON, a step up from April's 75,000 RON but still well below the Q4 2025 pace.",
          children: [
            /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(
              ComposedChart,
              {
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  color: C.terracotta,
                  label: "May 26 new loan",
                  value: fmtRONfull(latest.ilBal - prev.ilBal) + " RON",
                  sub: "Up from 75k in April"
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `From \u20AC${fmtRONfull(DATA[0].ilBalEUR)} (Mar 25) to \u20AC${fmtRONfull(latest.ilBalEUR)} (May 26)`
                }
              )
            ] })
          ]
      ...
      /* @__PURE__ */ jsxs(
        Section,
        {
          ...
          subtitle: /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            " cash distributions to shareholders \u2014 figures already exclude any amounts reinvested back into the company via DP. Only money that effectively left the business is shown. Aug 2025 marks the peak (\u20AC136,572) reflecting an extraordinary distribution. May 2026 comes in at ",
            /* @__PURE__ */ jsxs("strong", { children: [
              "\u20AC",
              fmtRONfull(latest.shSpendEUR)
            ] }),
            ", the third-highest month in the window and modestly above the 15-month average, up from April's \u20AC",
            ...
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginTop: 16, paddingTop: 14, borderTop: `1px solid ${C.border}` }, children: [
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `\u20AC${fmtRONfull(latest.shSpendEUR)} \xB7 above 15-mo average`
                }
              ),
              /* @__PURE__ */ jsx(
                AggregateBox,
              ...
              /* @__PURE__ */ jsx(
                AggregateBox,
                {
                  ...
                  sub: `\u20AC${fmtRONfull(DATA.slice(-12).reduce((a, r) => a + r.shSpendEUR, 0))} \xB7 Jun 25 \u2013 May 26`
                }
              )
            ] })
          ]
      ...
      /* @__PURE__ */ jsxs("footer", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 11, color: C.muted }, children: [
          ...
          " \xB7 CFO Reporting \xB7 Treasury & Cashflow \xB7 Period: Mar 2025 \u2013 May 2026 \xB7 All figures in RON \xB7 OPCO + PROPCO consolidated"
        ] }),
